                                        ...
                                        @foreach ($employees as $index => $employee)
                                            <tr>
                                                ...
                                                @if ($employee->attendanceToday)
                                                    <td>
                                                        <h6 class="text-center"><span
                                                                class="badge badge-pill badge-success">Recorded</span></h6>
                                                    </td>
                                                    <td>
                                                        Recorded at
                                                        {{ $employee->attendanceToday->created_at->format('H:i:s') }} from
                                                        {{ $employee->attendanceToday->entry_location }} with IP
                                                        {{ $employee->attendanceToday->entry_ip }}
                                                    </td>
                                                    @if ($employee->attendanceToday->exit_ip)
                                                        <td>
                                                            <h6 class="text-center"><span
                                                                    class="badge badge-pill badge-success">Recorded</span>
                                                            </h6>
                                                        </td>
                                                        <td>
                                                            Recorded at
                                                            {{ $employee->attendanceToday->updated_at->format('H:i:s') }}
                                                            from {{ $employee->attendanceToday->exit_location }} with IP
                                                            {{ $employee->attendanceToday->exit_ip }}
                                                        </td>
                                                    @else
                                                        <td>
                                                            <h6 class="text-center"><span
                                                                    class="badge badge-pill badge-danger">No Record</span>
                                                            </h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="text-center"><span
                                                ...
                                                @else
                                                    <td>
                                                        <h6 class="text-center"><span
                                                                class="badge badge-pill badge-danger">No Record</span></h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="text-center"><span
                                                                class="badge badge-pill badge-danger">No Record</span></h6>
                                                ...
                                                <td>
                                                    @if ($employee->attendanceToday)
                                                        {{ (new \Carbon\Carbon($employee->attendanceToday->created_at))->diff(new \Carbon\Carbon($employee->attendanceToday->created_at))->format('%h:%I') }}
                                                    @else
                                                        N/A
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    @if ($employee->attendanceToday)
                                                        <button class="btn btn-flat btn-danger" data-toggle="modal"
                                                            data-target="#deleteModalCenter{{ $employee->attendanceToday->id }}">Delete
                                                            Record</button>
                                                    @else
