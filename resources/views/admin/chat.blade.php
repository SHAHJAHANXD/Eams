            ...
            <div class="col-lg-12" style="    margin-top: 30px;">
                <div class="card chat-app">
                    <div id="plist" class="people-list">
                        ...
                        <ul class="list-unstyled chat-list mt-2 mb-0">
                            @foreach ($user as $user)
                                <li class="clearfix">
                                    <a href="/admin/chat-with/{{ $user->id }}">
                                        @if ($user->photo)
                    ...
                    <div class="chat">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="chat-about">
                                        <h6 class="m-b-0">{{ $username->name }}</h6>
                        ...
                        {{-- <div class="chat-history" style="height: 430px; overflow:auto;">
                            <ul class="m-b-0">
                                @php
                                    $id = Auth::user()->id;
                                @endphp
                                    ...
                                    @foreach ($room_dev as $room_dev)
                                        @if ($room_dev->sender_id == $id)
                                            <li class="clearfix">
                                                ...
                                                <div class="message other-message float-right"> {{ $room_dev->message }}
                                                </div>
                                            </li>
                                        @elseif ($room_dev->receiver_id == $id)
                                            <li class="clearfix">
                        ...
                        <livewire:chat-receive :id="$username->id" />
                        {{-- <livewire:chat-send /> --}}
                        @livewire('chat-send', ['id' => $username->id])
                        {{-- <form action="/employee/save-chat" method="POST" class="bg-light"
                            ...
                            <div class="input-group">
                                ...
                                @isset($userNames)
                                    @foreach ($userNames as $user)
                                        <input type="text" hidden value="{{ $user->id }}" name="receiver_id">
                                    @endforeach
                                @endisset
